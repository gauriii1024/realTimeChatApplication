      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100'>
        ...
        <form onSubmit={onSubmitHandler} action="">
          <div>
            ...
            <input value={user.fullName} onChange={(e) => setUser({
          ...
          <div>
            ...
            <input value={user.confirmPassword} onChange={(e) => setUser({
          ...
          <p className='text-center my-2'>Already have an account?  <Link className='text-center' to='/login'>Login</Link></p>
          <div>
